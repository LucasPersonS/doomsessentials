...
public class UpdateInjuryLevelPacket {
   ...
   public static void handle(UpdateInjuryLevelPacket msg, Supplier<NetworkEvent.Context> ctx) {
      ctx.get().enqueueWork(() -> {
         DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () -> InjuryClientPacketHandler.handleUpdateInjuryLevel(msg));
      });
