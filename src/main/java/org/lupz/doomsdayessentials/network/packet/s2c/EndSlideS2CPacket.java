...
public class EndSlideS2CPacket {
	private final UUID playerId;
	public EndSlideS2CPacket(UUID playerId) { this.playerId = playerId; }
	public EndSlideS2CPacket(FriendlyByteBuf buf) { this.playerId = buf.readUUID(); }
