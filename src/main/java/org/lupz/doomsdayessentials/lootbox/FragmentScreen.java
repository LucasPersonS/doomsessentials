...
/**
 * Tela GUI para troca de fragmentos por lootboxes
 * Segue o mesmo padrão do KitScreen
 */
public class FragmentScreen extends AbstractContainerScreen<FragmentMenu> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("minecraft",
            "textures/gui/container/generic_54.png");

    public FragmentScreen(FragmentMenu menu, Inventory inv, Component title) {
