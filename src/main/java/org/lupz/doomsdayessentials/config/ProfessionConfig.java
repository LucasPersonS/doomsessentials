...
public final class ProfessionConfig {
    ...
    public static final ForgeConfigSpec.IntValue RASTREADOR_COOLDOWN_MINUTES;
    ...
    static {
        ...
        COMBATENTE_MAX_COUNT = BUILDER.defineInRange("maxCount", 5, 0, 1000);
        BUILDER.pop();
        ...
        RASTREADOR_COOLDOWN_MINUTES = BUILDER.defineInRange("cooldownMinutes", 60, 1, 1440);
        BUILDER.pop();
