...
public class GuildUpgradeScreen extends AbstractContainerScreen<GuildUpgradeMenu> {
    ...
    public GuildUpgradeScreen(GuildUpgradeMenu menu, Inventory inv, Component title) {
        super(menu, inv, Component.literal("§6Upgrades de Organização"));
        this.imageWidth = 176;
