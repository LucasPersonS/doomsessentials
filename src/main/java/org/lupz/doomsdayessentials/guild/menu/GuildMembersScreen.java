...
public class GuildMembersScreen extends AbstractContainerScreen<GuildMembersMenu> {
    ...
    public GuildMembersScreen(GuildMembersMenu menu, Inventory inv, Component title) {
        super(menu, inv, Component.literal("§6Membros da Organização"));
        this.imageWidth = 176;
