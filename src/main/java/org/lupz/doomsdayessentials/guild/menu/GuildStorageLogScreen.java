...
public class GuildStorageLogScreen extends AbstractContainerScreen<GuildStorageLogMenu> {
    ...
    public GuildStorageLogScreen(GuildStorageLogMenu menu, Inventory inv, Component title) {
        super(menu, inv, Component.literal("§6Histórico do Cofre"));
        this.imageWidth = 176;
