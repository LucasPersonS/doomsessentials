...
public class GuildResourceDepositScreen extends AbstractContainerScreen<GuildResourceDepositMenu> {
    ...
    public GuildResourceDepositScreen(GuildResourceDepositMenu menu, Inventory inv, Component title) {
        super(menu, inv, Component.literal("§6Depósito de Recursos"));
        this.imageWidth = 176;
