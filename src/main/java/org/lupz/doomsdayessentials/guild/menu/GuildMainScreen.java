...
public class GuildMainScreen extends AbstractContainerScreen<GuildMainMenu> {
    ...
    public GuildMainScreen(GuildMainMenu menu, Inventory inv, Component title) {
        super(menu, inv, Component.literal("§6Organizações"));
        this.imageWidth = 176;
        this.imageHeight = 222; // 6 rows chest height like reward screen
    }
    ...
    protected void renderLabels(GuiGraphics graphics, int mouseX, int mouseY) {
        // Hide default container titles (prevents duplicated "Organizações" and "Inventory").
    }
