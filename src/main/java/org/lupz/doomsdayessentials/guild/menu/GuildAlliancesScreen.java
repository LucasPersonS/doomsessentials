...
public class GuildAlliancesScreen extends AbstractContainerScreen<GuildAlliancesMenu> {
    ...
    public GuildAlliancesScreen(GuildAlliancesMenu menu, Inventory inv, Component title) {
        super(menu, inv, Component.literal("§6Alianças"));
        this.imageWidth = 176;
