...
public class ModSounds {
	...
	public static final DeferredRegister<SoundEvent> SOUND_EVENTS = DeferredRegister
			.create(ForgeRegistries.SOUND_EVENTS, EssentialsMod.MOD_ID);
	...
	public static final RegistryObject<SoundEvent> RECYCLER_LOOP = SOUND_EVENTS.register("recycler_loop",
			() -> SoundEvent.createVariableRangeEvent(
					ResourceLocation.fromNamespaceAndPath(EssentialsMod.MOD_ID, "recycler_loop")));
	...
	private static RegistryObject<SoundEvent> register(String name) {
		...
		return SOUND_EVENTS.register(name, () -> SoundEvent
				.createFixedRangeEvent(ResourceLocation.fromNamespaceAndPath(EssentialsMod.MOD_ID, name), 16f));
	}
